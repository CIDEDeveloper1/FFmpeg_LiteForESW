...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--arch=x86 --target-os=mingw32 --cross-prefix=i686-w64-mingw32- --disable-autodetect --disable-everything --enable-network --enable-muxer=flv --enable-demuxer=flv --enable-protocol=file --enable-protocol=rtmp --disable-debug --enable-schannel --disable-ffplay --disable-ffprobe --enable-decoder=vp6f
prefix=/usr/local
...
CC_IDENT=gcc 5.3.1 (GCC) 20160211
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
...
DEPCC=i686-w64-mingw32-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=i686-w64-mingw32-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=yasm
DEPX86ASM=yasm
...
ARFLAGS=rcD
AR_O=$@
AR_CMD=i686-w64-mingw32-ar
NM_CMD=i686-w64-mingw32-nm -g
RANLIB=:
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__ -D_WIN32_WINNT=0x0600 -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
...
DEPWINDRES=i686-w64-mingw32-gcc
DOXYGEN=doxygen
LDFLAGS=  -Wl,--large-address-aware -Wl,--nxcompat,--dynamicbase -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS= -Wl,--pic-executable,-e,_mainCRTStartup
LDSOFLAGS=
SHFLAGS=-shared -Wl,--out-implib,$(SUBDIR)lib$(SLIBNAME:$(SLIBSUF)=.dll.a) -Wl,--disable-auto-image-base $$(@:$(SLIBSUF)=.def) -Wl,-Bsymbolic -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
ASMSTRIPFLAGS= -x
X86ASMFLAGS=-f win32 -DPREFIX
BUILDSUF=
PROGSSUF=
...
EXTRALIBS-avformat=-lm -lws2_32
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-lm -luser32 -lbcrypt
EXTRALIBS-postproc=-lm
EXTRALIBS-swresample=-lm
EXTRALIBS-swscale=-lm
EXTRALIBS-ffplay=-lshell32

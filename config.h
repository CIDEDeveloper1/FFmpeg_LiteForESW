...
#define FFMPEG_CONFIGURATION "--arch=x86 --target-os=mingw32 --cross-prefix=i686-w64-mingw32- --disable-autodetect --disable-everything --enable-network --enable-muxer=flv --enable-demuxer=flv --enable-protocol=file --enable-protocol=rtmp --disable-debug --enable-schannel --disable-ffplay --disable-ffprobe --enable-decoder=vp6f"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 5.3.1 (GCC) 20160211"
